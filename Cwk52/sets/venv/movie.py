...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        Label(self,
              text="Hwk 5.2 - Movie Database",
              font=("Helvetica", 16, 'bold'),
              highlightbackground='#3E4149',
              ).grid(row=0, column=0, sticky=W, pady=4)

        Label(self,
              text="Choose one actor from each column:",
              font=("Helvetica", 14)
        ...
        Label(self, text="Enter an Actor's full name to get their IMB Id").grid(row=11, column=0, sticky=W, pady=4)
